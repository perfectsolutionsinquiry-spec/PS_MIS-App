...
| `AriaControls.tsx` | Shared React Aria Components wrappers for text fields, textareas, selects, and checkboxes. These preserve the application's existing visual styles while standardizing accessible interaction behavior. | — |
