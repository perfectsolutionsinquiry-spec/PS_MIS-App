...
| `PageHeader.tsx` | Shared all-caps title and actions used by the Overview screen; the Customers list uses its own table controls instead of a separate top header. | — |
